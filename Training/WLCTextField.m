...
//    self.rightView = label;
    ...
    UIView *rightView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 30, self.height)];
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(1, 6, 1, 28)];
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(9, 18, 12, 6)];
